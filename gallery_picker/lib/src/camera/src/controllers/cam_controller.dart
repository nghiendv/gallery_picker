...
class CamController extends ValueNotifier<ActionValue> {
  ...
  /// Take picture
  Future<GallaryEntity?> takePicture() async {
    if (!initialized) {
    ...
    try {
      ...
      if (entity != null) {
        final gallaryEntity = GallaryEntity(entity: entity, bytes: data);
        await SystemChrome.setEnabledSystemUIOverlays(SystemUiOverlay.values);
        _uiHandler.pop<GallaryEntity>(gallaryEntity);
    ...
    if (value.isRecordingVideo) {
      try {
        ...
        if (entity != null) {
          ...
          final gallaryEntity = GallaryEntity(entity: entity, bytes: d!);
          await SystemChrome.setEnabledSystemUIOverlays(SystemUiOverlay.values);
          _uiHandler.pop<GallaryEntity>(gallaryEntity);
          return;
        } else {
