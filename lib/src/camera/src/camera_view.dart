...
import 'package:gallery_picker/src/camera/src/widgets/camera_builder.dart';
...
class CameraView extends StatefulWidget {
  ...
  static Future<GallaryEntity?> pick(
    BuildContext context, {
    Duration? videoDuration,
    ResolutionPreset? resolutionPreset,
    ImageFormatGroup? imageFormatGroup,
  }) async {
    return Navigator.of(context).push<GallaryEntity>(
