...
import 'package:gallery_picker/src/sticker_booth/sticker_booth.dart';
...
class PlaygroundController extends ValueNotifier<PlaygroundValue> {
  ...
  Future<GallaryEntity?> takeScreenshot() async {
    try {
      ...
      if (boundary != null) {
        ...
        return GallaryEntity(entity: entity!, bytes: data);
      }
    } catch (e) {
