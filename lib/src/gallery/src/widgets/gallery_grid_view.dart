...
class GalleryGridView extends StatelessWidget {
  ...
  ///
  final void Function(GallaryEntity, BuildContext) onSelect;
...
class _MediaTile extends StatelessWidget {
  ...
  ///
  final ValueSetter<GallaryEntity> onPressed;
    ...
    return ColoredBox(
      ...
      child: FutureBuilder<Uint8List?>(
        ...
        builder: (context, snapshot) {
          ...
          if (hasData) {
            final dEntity =
                GallaryEntity(entity: entity!, bytes: snapshot.data!);
